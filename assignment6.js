...
window.onload = function () {
    ...
    if (id != null) {
        fetch(`http://localhost:5166/api/Patient/id=${id}`, {
            method: 'GET',
            headers: {
    ...
    if (id != null) {
        fetch(`http://localhost:5166/api/Patient/id=${id}`, {
            ...
            body: JSON.stringify({
                ...
                sex: document.getElementById("sex").value,//1,// document.getElementById("sex").options[document.getElementById("sex").selectedIndex].text,
        ...
        fetch('http://localhost:5166/api/Patient/create', {
            method: 'POST',
            headers: {
                'content-type': 'application/json'
            },
...
postData('http://localhost:5166/api/Patient/GetList?PageNumber=1&PageSize=5')
    .then((data) => {
...
let api2 = 'http://localhost:5166/api/Patient/';
...
/*let api3 = 'http://localhost:5166/api/Patient/update';
function postApiCall() {
    fetch(api3, {
        method: 'PUT',
        headers: {
