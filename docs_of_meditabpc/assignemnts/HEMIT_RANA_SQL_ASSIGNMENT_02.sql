...
begin
	if firstName is NULL and lastName is NULL and gender is NULL and dateofbirth is NULL then 
...
select * from search_patient(1,8,first_Name=>'HEMIT',last_Name=>'RANA'); --search by fname and lname
select * from search_patient(2,2,first_Name=>null,last_Name=>'RANA',gender=>'MALE',dateofbirth=>NULL); --search by lastname and gender
select * from search_patient(2,2,first_Name=>null,last_Name=>'RANA',gender=>null,dateofbirth=>'2001-01-01'); --search by lastname and dob
select * from search_patient(1,2,first_Name=>null,last_Name=>'RANA',gender=>null,dateofbirth=>null,orderby=>'t1.dob'); --order by dateofbirth
